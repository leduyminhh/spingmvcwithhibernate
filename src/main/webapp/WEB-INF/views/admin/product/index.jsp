					...
					<div class="row">
						...
						<div class="col-6 text-right">
							<a href="${pageContext.request.contextPath}/admin/product/create"
								...
								Thêm mới</a> <a
								href="${pageContext.request.contextPath}/admin/product/listtrash"
				...
				<div class="card-body">
					...
					<table class="table table-bordered table-hover table-striped">
						...
						<c:forEach var="listProduct" items="${listProduct}">
							<tbody>
								<tr>
									<th><img src="${pageContext.request.contextPath}/resources/img/product/${listProduct.image}"  width="40" height="50"></th> 
									...
									<th><c:if test="${listProduct.status==1}">
										...
										href="${pageContext.request.contextPath}/admin/product/edit?id=${listProduct.id}"
										class="btn btn-sm btn-success">Sửa<i class="far fa-edit"></i></a>
										<a
										href="${pageContext.request.contextPath}/admin/product/deltrash?id=${listProduct.id}"
