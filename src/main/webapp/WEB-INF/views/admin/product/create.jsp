...
<form:form id="loginForm"
	...
	method="POST" modelAttribute="pro">
	<div id="page-wrapper">
						...
						<div class="row">
							<div class="col-md-9">
								<div class="form-group">
									...
									<form:input class="form-control" id="image" name="image" path="image" />
								</div>
								<div class="form-group">
									<form:label class="text-info" path="title">Tên Sản Phẩm</form:label>
									<form:input class="form-control" id="title" name="title" path="title" />
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<form:input class="form-control" id="price_net"
										name="price_net" path="price_net" />
								</div>
								<div class="form-group">
									<form:label class="text-info" path="available">Số Lượng</form:label>
									<form:input class="form-control" id="available" name="available" path="available" />
								</div>
								<div class="form-group">
									<form:label class="text-info" path="discount">Giảm Giá(%)</form:label>
									<form:input class="form-control" id="discount" name="discount" path="discount" />
								</div>
								<div class="form-group">
